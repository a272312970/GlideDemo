 ...
 *
 */
public class LoadingImgViewWithProgress extends ImageView {
    ...
    public LoadingImgViewWithProgress(Context context) {
        super(context);
        mContext = context;
    }

    public LoadingImgViewWithProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
